...
import WebPortal from './pages/web';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/student/jobs/:jobid" element={<ProtectedRoute><Jobs /></ProtectedRoute>} />
        ...
        <Route path="/admin/status" element={<ProtectedAdminRoute><Posting /></ProtectedAdminRoute>} />
